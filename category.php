<?php get_header(); ?>
                ...
                <div id="container">    
						...
						<?php the_post(); ?>                    
                                ...
                                <h1 class="page-title"><?php _e( 'Category Archives:', 'nano-blogger' ) ?> <span><?php single_cat_title() ?></span></span></h1>
						...
						<?php if ( $cats_meow = cats_meow(', ') ) : // Returns categories other than the one queried ?>
                                                <span class="cat-links"><?php printf( __( 'Also posted in %s', 'nano-blogger' ), $cats_meow ) ?></span>
                                                <span class="meta-sep"> | </span>
						<?php endif ?>
