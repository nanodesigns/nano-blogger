<?php get_header(); ?>
                ...
                <div id="container">    
						...
						<?php the_post(); ?>                    
                                ...
                                <h1 class="page-title"><?php _e( 'Tag Archives:', 'nano-blogger' ) ?> <span><?php single_tag_title() ?></span></h1>
...
<?php if ( $tag_ur_it = tag_ur_it(', ') ) : // Returns tags other than the one queried ?>                                               
                                                <span class="tag-links"><?php printf( __( 'Also tagged %s', 'nano-blogger' ), $tag_ur_it ) ?></span>
<?php endif; ?>                                         
